...
* Add input support for EBU Teletext in MPEG-TS ([#1344](https://github.com/MetaCDN/shaka-packager/issues/1344)) ([71c175d](https://github.com/MetaCDN/shaka-packager/commit/71c175d4b8fd7dd1ebb2df8ce06c575f54666738))
* add missing DASH roles from ISO/IEC 23009-1 section 5.8.5.5 ([#1390](https://github.com/MetaCDN/shaka-packager/issues/1390)) ([fe885b3](https://github.com/MetaCDN/shaka-packager/commit/fe885b3ade020b197a04fc63ee41fd90e7e11a14))
* Add PlayReady support in HLS. ([#1011](https://github.com/MetaCDN/shaka-packager/issues/1011)) ([96efc5a](https://github.com/MetaCDN/shaka-packager/commit/96efc5aa70c2152a242f36644100161bc562d3f7))
* add startwithSAP/subsegmentstartswithSAP for audio tracks ([#1346](https://github.com/MetaCDN/shaka-packager/issues/1346)) ([d23cce8](https://github.com/MetaCDN/shaka-packager/commit/d23cce85b93263a4c7541d9761145be54dd1348d))
* Add support for ALAC codec ([#1299](https://github.com/MetaCDN/shaka-packager/issues/1299)) ([b68ec87](https://github.com/MetaCDN/shaka-packager/commit/b68ec87f6a552c27882746a14415bb334041d86b))
* Add support for single file TS for HLS ([#934](https://github.com/MetaCDN/shaka-packager/issues/934)) ([4aa4b4b](https://github.com/MetaCDN/shaka-packager/commit/4aa4b4b9aac08fdcf10954de37b9982761fa42c1))
* Add support for the EXT-X-START tag ([#973](https://github.com/MetaCDN/shaka-packager/issues/973)) ([76eb2c1](https://github.com/MetaCDN/shaka-packager/commit/76eb2c1575d4c8b32782292dc5216c444a6f2b27))
...
* Allow LIVE UDP WebVTT input ([#1349](https://github.com/MetaCDN/shaka-packager/issues/1349)) ([89376d3](https://github.com/MetaCDN/shaka-packager/commit/89376d3c4d3f3005de64dd4bc1668297024dfe46))
* **DASH:** Add Label element. ([#1175](https://github.com/MetaCDN/shaka-packager/issues/1175)) ([b1c5a74](https://github.com/MetaCDN/shaka-packager/commit/b1c5a7433e1c148fb6648aadd36c14840e1a4b50))
...
* default text zero bias ([#1330](https://github.com/MetaCDN/shaka-packager/issues/1330)) ([2ba67bc](https://github.com/MetaCDN/shaka-packager/commit/2ba67bc24cf6116349ad16d3bfa1a121c95a3173))
...
* get start number from muxer and specify initial sequence number ([#879](https://github.com/MetaCDN/shaka-packager/issues/879)) ([bb104fe](https://github.com/MetaCDN/shaka-packager/commit/bb104fef5d745ac3a0a8c1e6fb4f1b1a9b27d8ae))
* HLS / DASH support forced subtitle ([#1020](https://github.com/MetaCDN/shaka-packager/issues/1020)) ([f73ad0d](https://github.com/MetaCDN/shaka-packager/commit/f73ad0d9614ba5b1ba552385c0157b7017dba204))
* order streams in manifest based on command-line order ([#1329](https://github.com/MetaCDN/shaka-packager/issues/1329)) ([aad2a12](https://github.com/MetaCDN/shaka-packager/commit/aad2a12a9d6b79abe511d66e9e8d936e0ba46cb4))
* Parse MPEG-TS PMT ES language and maximum bitrate descriptors ([#369](https://github.com/MetaCDN/shaka-packager/issues/369)) ([#1311](https://github.com/MetaCDN/shaka-packager/issues/1311)) ([c09eb83](https://github.com/MetaCDN/shaka-packager/commit/c09eb831b85c93eb122373ce82b64c354d68c3c1))
* Portable, fully-static release executables on Linux ([#1351](https://github.com/MetaCDN/shaka-packager/issues/1351)) ([9be7c2b](https://github.com/MetaCDN/shaka-packager/commit/9be7c2b1ac63d2299ed8293c381ef5877003b5c4))
...
* support Dolby Vision profile 8.x (HEVC) and 10.x (AV1) in HLS and DASH  ([#1396](https://github.com/MetaCDN/shaka-packager/issues/1396)) ([a99cfe0](https://github.com/MetaCDN/shaka-packager/commit/a99cfe036f09de51b488f87f4cb126a1bcd3a286))
* teletext formatting ([#1384](https://github.com/MetaCDN/shaka-packager/issues/1384)) ([4b5e80d](https://github.com/MetaCDN/shaka-packager/commit/4b5e80d02c10fd1ddb8f7e0f2f1a8608782d8442))
* This patch adds support for DTS:X Profile 2 audio in MP4 files. ([#1303](https://github.com/MetaCDN/shaka-packager/issues/1303)) ([07f780d](https://github.com/MetaCDN/shaka-packager/commit/07f780dae19d7953bd27b646d9410ed68b4b580e))
...
* adaptation set IDs were referenced by lowest representation ID  ([#1394](https://github.com/MetaCDN/shaka-packager/issues/1394)) ([94db9c9](https://github.com/MetaCDN/shaka-packager/commit/94db9c9db3e73073925205355dd61a6dc9785065)), closes [#1393](https://github.com/MetaCDN/shaka-packager/issues/1393)
...
* Always log to stderr by default ([#1350](https://github.com/MetaCDN/shaka-packager/issues/1350)) ([35c2f46](https://github.com/MetaCDN/shaka-packager/commit/35c2f4642830e1446701abe17ae6d3b96d6043ae)), closes [#1325](https://github.com/MetaCDN/shaka-packager/issues/1325)
* AudioSampleEntry size caluations due to bad merge ([#1354](https://github.com/MetaCDN/shaka-packager/issues/1354)) ([615720e](https://github.com/MetaCDN/shaka-packager/commit/615720e7dd9699f2d90c63d4bb6ac45c0e804d32))
* BaseURL missing when MPD base path is empty ([#1380](https://github.com/MetaCDN/shaka-packager/issues/1380)) ([90c3c3f](https://github.com/MetaCDN/shaka-packager/commit/90c3c3f9b3e8e36706b9769e574aa316e8bbb351)), closes [#1378](https://github.com/MetaCDN/shaka-packager/issues/1378)
* **CI:** Add Mac-arm64 to build matrix ([#1359](https://github.com/MetaCDN/shaka-packager/issues/1359)) ([c456ad6](https://github.com/MetaCDN/shaka-packager/commit/c456ad64d1291bcf057c22a5c34479fcb4bbda55))
...
* duplicate representation id for TTML when forced ordering is on ([#1364](https://github.com/MetaCDN/shaka-packager/issues/1364)) ([0fd815a](https://github.com/MetaCDN/shaka-packager/commit/0fd815a160cc4546ea0c13ac916727777f5cdd41)), closes [#1362](https://github.com/MetaCDN/shaka-packager/issues/1362)
* duration formatting and update mpd testdata to reflect new format ([#1320](https://github.com/MetaCDN/shaka-packager/issues/1320)) ([56bd823](https://github.com/MetaCDN/shaka-packager/commit/56bd823339bbb9ba94ed60a84c554864b42cf94a))
* escape media URLs in MPD ([#1395](https://github.com/MetaCDN/shaka-packager/issues/1395)) ([98b44d0](https://github.com/MetaCDN/shaka-packager/commit/98b44d01df6a952466b5a1667818da877502da97))
...
* Fix missing newline at the end of usage ([#1352](https://github.com/MetaCDN/shaka-packager/issues/1352)) ([6276584](https://github.com/MetaCDN/shaka-packager/commit/6276584de784025380f46dca379795ed6ee42b8f))
* Fix NPM binary publication ([#1371](https://github.com/MetaCDN/shaka-packager/issues/1371)) ([4cb6536](https://github.com/MetaCDN/shaka-packager/commit/4cb653606047b086affc111321187c7889fa238a)), closes [#1369](https://github.com/MetaCDN/shaka-packager/issues/1369)
* Fix NPM binary selection on ARM Macs ([#1376](https://github.com/MetaCDN/shaka-packager/issues/1376)) ([733af91](https://github.com/MetaCDN/shaka-packager/commit/733af9128dfa7c46dd7a9fe3f8361ab50a829afe)), closes [#1375](https://github.com/MetaCDN/shaka-packager/issues/1375)
* Fix tags in official Docker images and binaries ([#1370](https://github.com/MetaCDN/shaka-packager/issues/1370)) ([d83c7b1](https://github.com/MetaCDN/shaka-packager/commit/d83c7b1d4505a08ef578390115cf28bea77404c2)), closes [#1366](https://github.com/MetaCDN/shaka-packager/issues/1366)
* Fix uninitialized value found by Valgrind ([#1336](https://github.com/MetaCDN/shaka-packager/issues/1336)) ([7ef5167](https://github.com/MetaCDN/shaka-packager/commit/7ef51671f1a221443bcd000ccb13189ee6ccf749))
* hls, set the DEFAULT explicitly to NO. Supports native HLS players. ([#1170](https://github.com/MetaCDN/shaka-packager/issues/1170)) ([1ab6818](https://github.com/MetaCDN/shaka-packager/commit/1ab68188326685ab4e427e7a6eab0694e0b0b60a)), closes [#1169](https://github.com/MetaCDN/shaka-packager/issues/1169)
* http_file: Close upload cache on task exit ([#1348](https://github.com/MetaCDN/shaka-packager/issues/1348)) ([6acdcc3](https://github.com/MetaCDN/shaka-packager/commit/6acdcc394a1583b22c3c16cee3e419eea6c6e4f9)), closes [#1347](https://github.com/MetaCDN/shaka-packager/issues/1347)
...
* misleading log output when HLS target duration updates (fixes [#969](https://github.com/MetaCDN/shaka-packager/issues/969)) ([#971](https://github.com/MetaCDN/shaka-packager/issues/971)) ([f7b3986](https://github.com/MetaCDN/shaka-packager/commit/f7b3986818915ab3d7d3dc31b8316fcef0384294))
...
* preserve case for stream descriptors ([#1321](https://github.com/MetaCDN/shaka-packager/issues/1321)) ([5d44368](https://github.com/MetaCDN/shaka-packager/commit/5d44368478bbd0cd8bd06f0dfa739f8cfa032ddc))
...
* remove extra block assumptions in mbedtls integration ([#1323](https://github.com/MetaCDN/shaka-packager/issues/1323)) ([db59ad5](https://github.com/MetaCDN/shaka-packager/commit/db59ad582a353fa1311563bdde93c49449159859)), closes [#1316](https://github.com/MetaCDN/shaka-packager/issues/1316)
* Restore support for legacy FairPlay system ID ([#1357](https://github.com/MetaCDN/shaka-packager/issues/1357)) ([4d22e99](https://github.com/MetaCDN/shaka-packager/commit/4d22e99f8e7777557f5de3d5439f7e7b397e4323))
...
* set array_completeness in HEVCDecoderConfigurationRecord correctly ([#975](https://github.com/MetaCDN/shaka-packager/issues/975)) ([270888a](https://github.com/MetaCDN/shaka-packager/commit/270888abb12b2181ff84071f2c2685bd196de6fe))
* set yuv full range flag to 1 for VP9 with sRGB ([#1398](https://github.com/MetaCDN/shaka-packager/issues/1398)) ([f6f60e5](https://github.com/MetaCDN/shaka-packager/commit/f6f60e5fff8d5c9b13fbf65f494eba651050ccb9))
...
* use a better estimate of frame rate for cases with very short first sample durations ([#838](https://github.com/MetaCDN/shaka-packager/issues/838)) ([5644041](https://github.com/MetaCDN/shaka-packager/commit/56440413aa32a13cbfbb41a6d5ee611bae02ab2e))
